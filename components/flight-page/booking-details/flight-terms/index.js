...
import { FlightTermWrapper, Title, Subtitle, List, ListItem } from '../style'
...
const FlightTerms = ({title, subtitle, terms}) => {
  return (
    <FlightTermWrapper>
      <Title>{title}</Title>
      <div>
        ...
        {terms.map((term, index)=>{
            return(
                <List>
                    <ListItem>- <p>{term.text}</p></ListItem>
                </List>
           )
        })}
      ...
      <div>
        <Subtitle>Contact Us</Subtitle>
                ...
                <List>
                    <ListItem><p>If you have any questions about our Website or our Terms of Use, please contact:<br />
